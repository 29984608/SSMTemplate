...
<head>
  ...
  <link rel="stylesheet" href="../../public/src/css/app.css" media="all" />
  <link rel="stylesheet" href="../../public/src/css/themes/default.css" media="all" id="skin" kit-skin />
</head>
    ...
    layui.config({
      ...
      $('#pay').on('click', function() {
        layer.open({
          title: false,
          type: 1,
          content: '<img src="../../public/src/images/pay.png" />',
          area: ['500px', '250px'],
          shadeClose: true
        });
      });
